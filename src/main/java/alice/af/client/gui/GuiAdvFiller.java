...
public final class GuiAdvFiller extends GuiContainer {
    ...
    private static final ResourceLocation GUI = new ResourceLocation(
        "advfiller",
        "textures/gui/container/advfiller.png");
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        this.fontRendererObj
            .drawString(str, this.cx + 29 - this.fontRendererObj.getStringWidth(str) / 2, this.cy + 23, 65280);
        str = String.valueOf(this.right);
        this.fontRendererObj
            .drawString(str, this.cx + 79 - this.fontRendererObj.getStringWidth(str) / 2, this.cy + 23, 65280);
        str = String.valueOf(this.up);
        this.fontRendererObj
            .drawString(str, this.cx + 129 - this.fontRendererObj.getStringWidth(str) / 2, this.cy + 23, 65280);
        str = String.valueOf(this.down);
        this.fontRendererObj
            .drawString(str, this.cx + 179 - this.fontRendererObj.getStringWidth(str) / 2, this.cy + 23, 65280);
        str = String.valueOf(this.forward);
        this.fontRendererObj
            .drawString(str, this.cx + 229 - this.fontRendererObj.getStringWidth(str) / 2, this.cy + 23, 65280);
        str = "LEFT:";
